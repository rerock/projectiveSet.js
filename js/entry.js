...
$('#about').click(function(){
  ...
  $(".be_formular").append("<h1>The 2<sup>N</sup> - 1 number of cards can be represented as the nonzero vectors in the N-dimensional vector space over the 2-element field 𝔽<sub>2</sub>: The N coordinates correspond to the N colors. If a color is present on a card, the corresponding entry is 1 and otherwise 0.</h1>");
